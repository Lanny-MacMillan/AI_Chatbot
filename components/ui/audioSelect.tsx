...
const SelectAudio = ({setDownloadAudio}: any) => (
  <Select.Root onValueChange={(audio)=>{setDownloadAudio(audio)}}>
    <Select.Trigger
    ...
    >
      <Select.Value placeholder="Choose Audio" />
      ...
      <Select.Content className="overflow-hidden bg-white rounded-md shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]">
        ...
        <Select.Viewport className="p-[5px]">
          <Select.Group>
            ...
            <SelectItem value="true">Download</SelectItem>
            <SelectItem value="false">Listen</SelectItem>
          </Select.Group>
        </Select.Viewport>
